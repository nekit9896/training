...
def is_desired_type(msg: List[Any], message_type: str) -> bool:
    ...
    """
    return len(msg) > WS_Const.EVENT_TYPE_INDEX and msg[WS_Const.EVENT_TYPE_INDEX] == message_type
...
def is_desired_invocation_id(msg: List[Any], invocation_id: str) -> bool:
    ...
    """
    return len(msg) > WS_Const.INVOCATION_ID_INDEX and str(msg[WS_Const.INVOCATION_ID_INDEX]) == str(invocation_id)
