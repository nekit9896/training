...
from models.subscribe_input_signals_model import (InputSignal,
                                                  SubscribeInputSignalsContent,
                                                  SubscribeInputSignalsReply)
...
MessageType = TypeVar(
    "MessageType"
)  # создает типовую переменную для парсинга сообщений
...
class WsMessageParser:
            ...
            if isinstance(value, list) and len(value) == 2:
                ...
                if isinstance(time_timestamp, Timestamp):
                    ...
                    return datetime.fromtimestamp(
                        time_timestamp.seconds, datetime_timezone
                    )
    ...
    def parse_output_signals_msg(self, data: list):
        ...
        parsed_payload = self._parse_message(
            data_class=GetOutputSignalsReply, data=payload
        )
    ...
    def parse_input_signals_msg(self, data: list) -> GetInputSignalsReply:
        ...
        payload = self._find_reply_status_in_ws_msg(data)
        parsed_payload = self._parse_message(
            data_class=GetInputSignalsReply, data=payload
        )
    ...
    def parse_acknowledge_leak_msg(self, data: list) -> AcknowledgeLeakReply:
        ...
        payload = self._find_reply_status_in_ws_msg(data)
        parsed_payload = self._parse_message(
            data_class=AcknowledgeLeakReply, data=payload
        )
    ...
    def parse_main_page_msg(self, data: list) -> SubscribeMainPageInfoReply:
        ...
        payload = self._find_reply_status_in_ws_msg(data)
        parsed_payload = self._parse_message(
            data_class=SubscribeMainPageInfoReply, data=payload
        )
    ...
    def parse_all_leaks_info_msg(self, data: list) -> SubscribeAllLeaksInfoReply:
        ...
        payload = self._find_reply_status_in_ws_msg(data)
        parsed_payload = self._parse_message(
            data_class=SubscribeAllLeaksInfoReply, data=payload
        )
    ...
    def parse_leaks_info_msg(self, data: list) -> SubscribeLeaksReply:
        ...
        payload = self._find_reply_status_in_ws_msg(data)
        parsed_payload = self._parse_message(
            data_class=SubscribeLeaksReply, data=payload
        )
    ...
    def parse_output_signals_info_msg(self, data: list):
        ...
        payload = self._find_reply_status_in_ws_msg(data)
        parsed_payload = self._parse_message(
            data_class=SubscribeOutputSignalsReply, data=payload
        )
        return parsed_payload
    ...
    def parse_tu_leaks_info_msg(self, data: list) -> SubscribeTuLeaksInfoReply:
        ...
        payload = self._find_reply_status_in_ws_msg(data)
        parsed_payload = self._parse_message(
            data_class=SubscribeTuLeaksInfoReply, data=payload
        )
    ...
    def parse_common_scheme_info_msg(self, data: list) -> SubscribeCommonSchemeReply:
        ...
        payload = self._find_reply_status_in_ws_msg(data)
        parsed_payload = self._parse_message(
            data_class=SubscribeCommonSchemeReply, data=payload
        )

        return parsed_payload

    def _parse_message(
        self, data_class: Type[MessageType], data: dict, config: Optional[Config] = None
    ) -> MessageType:
        """
