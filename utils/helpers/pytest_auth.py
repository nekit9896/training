...
def _fetch_x_user_id(http_client: StandHttpClient) -> str:
    """
    Запрашивает x-user-id через POST /apigateway/Ping.
    ...
    if not x_user_id:
        pytest.exit("[HTTP_CLIENT] [ERROR] Ping не вернул x-user-id")
