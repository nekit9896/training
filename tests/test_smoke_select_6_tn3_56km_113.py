"""
Smoke-тесты СОУ для набора данных Select_6_tn3_56km_113.

Запуск:
    pytest tests/test_smoke_select_6_tn3_56km_113.py

Данные:
    - ТУ: Тихорецк-Новороссийск-3
    - Координата утечки: 56 км
    - Объем утечки: 113 м³/ч
"""

import pytest

from tests.test_config import SELECT_6_CONFIG
