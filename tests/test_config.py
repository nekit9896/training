...
SELECT_17_CONFIG = TestDataConfig(
    ...
    offsets=TestOffsets(
        ...
        leaks_content_leak_2=None,
        all_leaks_info_leak_2=None,
        tu_leaks_info_leak_2=None,
        acknowledge_leak_info_leak_2=None,
    ...
    test_case_ids=TestCaseIds(
        ...
        leaks_content_leak_2="0",
        all_leaks_info_leak_2="0",
        tu_leaks_info_leak_2="0",
        acknowledge_leak_info_leak_2="0",
...
SELECT_19_CONFIG = TestDataConfig(
    ...
    offsets=TestOffsets(
        ...
        mask_signal_msg=8,
        lds_status_initialization_out=30,
        leaks_content=47,  # LeaksContent первой утечки
        all_leaks_info=47,
        tu_leaks_info=47,
        lds_status_during_leak=47,
        acknowledge_leak_info=62,
        output_signals=63,
        main_page_info_unstationary=45,
        # --- Тесты для второй утечки (181 км) ---
        leaks_content_leak_2=61, 
        all_leaks_info_leak_2=61,
        tu_leaks_info_leak_2=61,
        acknowledge_leak_info_leak_2=62.5,
        output_signals_leak_2=63.5, 
    ),
    test_case_ids=TestCaseIds(
        basic_info="1",
        journal_info="2",
        ...
        leaks_content_leak_2="4",
        all_leaks_info_leak_2="4",
        tu_leaks_info_leak_2="5",
        acknowledge_leak_info_leak_2="6",
