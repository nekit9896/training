...
> Полная версия: [`doca`](../doca) в корне репозитория (master).
...
- если в одном прогоне несколько наборов и у одного не удалась подготовка стенда, его тесты будут **skipped**, следующий набор продолжит выполнение
