"""
Конфигурация тестового набора Imitative_2_tn3_106km_113 (режим остановленной перекачки)
...
# ===== Константы набора =====
SUITE_NAME = "Imitative_2_tn3_106km_113"
SUITE_DATA_ID = 21
...
# ===== Конфигурация набора =====
IMITATIVE_2_CONFIG = SmokeSuiteConfig(
    # ----- Метаданные -----
    ...
    leak=LeakTestConfig(
        ...
        # ----- Тест AllLeaksInfo -----
        all_leaks_info_test=CaseMarkers(test_case_id="21", offset=54),
        # ----- Тест LeaksContent -----
