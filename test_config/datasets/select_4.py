...
- Одна утечка на координатае 215 км
...
SELECT_4_CONFIG = SuiteConfig(
    ...
    main_page_info_test=CaseMarkers(
        test_case_id="44",
        offset=7,
        title=f"[MainPageInfo] Проверка установки режима остановленной перекачки на данных {SUITE_NAME}",
        tag="MainPageInfo",
        description=(
            f"Проверка сообщения MainPageInfo "
            f"об установке режима остановленной перекачки на наборе данных {SUITE_NAME}, \n"
            f"на технологическом участке {TECHNOLOGICAL_UNIT.description}\n"
            "Ожидаемое время установки режима остановленной перекачки: ~07:00\n"
        ),
    ),
    ...
    leak=LeakTestConfig(
        ...
        all_leaks_info_test=CaseMarkers(
            ...
            description=(
                ...
                f"об утечке на наборе данных {SUITE_NAME}, \n"
                f"на технологическом участке {TECHNOLOGICAL_UNIT.description}\n"
