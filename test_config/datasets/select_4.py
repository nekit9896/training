...
LEAK_VOLUME_M3 = 300.1  # в связи с изменениями сжимаемости
...
LEAK_DIAGNOSTIC_AREA_NAME = 'НПС-3 "Нововеличковская" - Т-Н-3.«Грушовая».УЗР'
# ID труб для определения ДУ
DIAGNOSTIC_AREA_2_PIPE_ID = 1100  # Труба на ДУ с утечкой
...
# ===== Конфигурация набора =====
SELECT_4_CONFIG = SmokeSuiteConfig(
    # ----- Метаданные -----
    ...
    controlled_sites_with_segment=CaseData(
        expected_result={
            ...
            "exp_novovelichkovskaya_krymskaya": (StationaryStatus.STOPPED, LdsStatus.DEGRADATION),
    ...
    stationary_status_main_page_info_test=CaseMarkers(test_case_id="44", offset=6),
    ...
    leak=LeakTestConfig(
        ...
        balance_algorithm_leak_waiting_test=CaseMarkers(test_case_id="175", offset=46),  # Длительность теста 5 минут
        ...
        possible_leak_in_journal_test=CaseMarkers(test_case_id="211", offset=51),
