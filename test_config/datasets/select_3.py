...
# ===== Конфигурация набора =====
SELECT_3_CONFIG = SmokeSuiteConfig(
    # ===== Метаданные =====
    ...
    leak=LeakTestConfig(
        ...
        balance_algorithm_leak_detected_test=CaseMarkers(test_case_id="", offset=65),
        # ----- Тест AllLeaksInfo -----
        ...
        possible_leak_in_journal_test=CaseMarkers(test_case_id="", offset=65),
        # ----- Тест TuLeaksInfo -----
