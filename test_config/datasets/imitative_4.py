"""
Конфигурация тестового набора Imitative_4_tn3_129km_113 (режим остановленной перекачки)
...
# ===== Константы набора =====
SUITE_NAME = "Imitative_4_tn3_129km_113"
SUITE_DATA_ID = 22
...
# Параметры утечки
LEAK_COORDINATE_METERS = 129000.0
...
LEAK_DIAGNOSTIC_AREA_NAME = "Т-Н-3.НПС-5 «Тихорецкая».УЗР СИКН ТН-3 - НПЗ Афипский"
...
# ===== Конфигурация набора =====
IMITATIVE_4_CONFIG = SmokeSuiteConfig(
    # ----- Метаданные -----
    ...
    leak=LeakTestConfig(
        ...
        # ----- Тест AllLeaksInfo -----
        all_leaks_info_test=CaseMarkers(test_case_id="22", offset=54),
        # ----- Тест LeaksContent -----
