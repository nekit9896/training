"""
Конфигурация тестового набора Imitative_41_tn3_56km_227
Особенности набора:
- Режим МТ стационар, максимальный
- Одна утечка на координате 56 км
- Объём утечки 227.2 м³
- Интенсивность утечки 7,2%
"""
...
# ===== Константы набора =====
SUITE_NAME = "Imitative_41_tn3_56km_227"
SUITE_DATA_ID = 30
...
# ===== Конфигурация набора =====
IMITATIVE_41_CONFIG = SmokeSuiteConfig(
    # ===== Метаданные =====
    ...
    controlled_sites_with_segment=CaseData(
        expected_result={
            ...
            "exp_novovelichkovskaya_krymskaya": (StationaryStatus.STATIONARY, LdsStatus.FAULTY),
            "exp_krymskaya_grushovaya": (StationaryStatus.STATIONARY, LdsStatus.FAULTY),
    ...
    leak=LeakTestConfig(
        ...
        # ----- Тест AllLeaksInfo -----
        all_leaks_info_test=CaseMarkers(test_case_id="30", offset=54),
        # ----- Тест LeaksContent -----
