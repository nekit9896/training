"""
Конфигурация тестового набора Imitative_7_tn3_215km_50 (режим остановленной перекачки)
...
# ===== Константы набора =====
SUITE_NAME = "Imitative_7_tn3_215km_50"
SUITE_DATA_ID = 23
...
# ===== Конфигурация набора =====
IMITATIVE_7_CONFIG = SmokeSuiteConfig(
    # ----- Метаданные -----
    ...
    leak=LeakTestConfig(
        ...
        expected_lds_status=LdsStatus.SERVICEABLE,  # При перестройке путей течения, Режим СОУ может меняться
        expected_stationary_status=StationaryStatus.STOPPED,
        ...
        # ----- Тест AllLeaksInfo -----
        all_leaks_info_test=CaseMarkers(test_case_id="23", offset=60),
        # ----- Тест LeaksContent -----
        leaks_content_test=CaseMarkers(test_case_id="91", offset=60),
        # ----- Тест TuLeaksInfo -----
        tu_leaks_info_test=CaseMarkers(test_case_id="84", offset=60),
        # ----- Тест MessageInfo -----
        leak_info_in_journal=CaseMarkers(test_case_id="154", offset=60),
        # ----- Тест MainPageInfoContent -----
        leak_is_confirm_on_main_page_test=CaseMarkers(test_case_id="182", offset=61),
