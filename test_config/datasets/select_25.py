"""
Конфигурация тестового набора Select_25_tn3_6km_56
Особенности набора:
...
# ===== Конфигурация набора =====
SELECT_25_CONFIG = SmokeSuiteConfig(
    # ===== Метаданные =====
    ...
    stationary_status_main_page_info_test=CaseMarkers(test_case_id="83", offset=6),
    ...
    leak=LeakTestConfig(
        ...
        # ----- Тест AllLeaksInfo -----
        all_leaks_info_test=CaseMarkers(test_case_id="11", offset=58.0),
        # ----- Тест TuLeaksInfo -----
        tu_leaks_info_test=CaseMarkers(test_case_id="84", offset=58.0),
        # ----- Тест LeakContent -----
        leaks_content_test=CaseMarkers(test_case_id="91", offset=58.0),
        # ----- Тест MessageInfo -----
        leak_info_in_journal=CaseMarkers(test_case_id="147", offset=58),
