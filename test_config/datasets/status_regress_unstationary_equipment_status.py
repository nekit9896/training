"""
Конфигурация тестового набора Status_regress_unstationary_equipment_status

Особенности набора:
- Режим МТ Нестационар
- Причина МТ: Пуск/остановка трубопровода; включение/отключение магистрального насоса; включение/отключение НПС
- Проверка режимов работы МТ
- Проверка причин режимов работы МТ
- Старт данных 19.03.2026 13:14:00.000
- Включение насоса AK.CHTN.NPS_VEL_3.MNA_4.ON ~ 13:24
- Начало нестационара примерно в 13:24, окончание примерно 13:31
- Выключение насоса AK.CHTN.NPS_VEL_3.MNA_4.ON ~ 13:34
...
# ===== Константы набора =====
SUITE_NAME = "Status_regress_unstationary_equipment_status"
SUITE_DATA_ID = 34
...
# ===== Конфигурация набора =====
STATUS_REGRESS_UNSTATIONARY_EQUIPMENT_STATUS_CONFIG = StationaryStatusConfig(
    # ----- Метаданные -----
    ...
    status_unstationary_switch_test_data=CaseData(
        params={TestConst.CONTROL_POINTS_KEY: CONTROL_POINTS},
        expected_result=(StationaryStatus.UNSTATIONARY, UnStationaryReason.CHANGING_EQUIPMENT_STATUS),
    ),
    ...
    journal_unstationary_switch_test_data=CaseData(
        ...
        expected_result=(
            StationaryStatus.UNSTATIONARY.report_text,
            UnStationaryReason.CHANGING_EQUIPMENT_STATUS.report_text,
        ),
    ),
    ...
    common_scheme_switch_on_test=CaseMarkers(test_case_id="34", offset=14),
