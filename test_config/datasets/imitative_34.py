"""
Конфигурация тестового набора Imitative_34_tn3_106km_113
Особенности набора:
- Режим МТ стационар, максимальный
- Одна утечка на координате 106 км
- Объём утечки 113.6 м³
- Интенсивность утечки 3,6%
- Отбор до НПС Нововеличковская (при регулировании ЧРП по уставке регулирования давления на входе МНС)
"""
...
# ===== Константы набора =====
SUITE_NAME = "Imitative_34_tn3_106km_113"
SUITE_DATA_ID = 27
...
# Параметры утечки
LEAK_COORDINATE_METERS = 106000.0
...
# ===== Конфигурация набора =====
IMITATIVE_34_CONFIG = SmokeSuiteConfig(
    # ----- Метаданные -----
    ...
    leak=LeakTestConfig(
        ...
        # ----- Тест AllLeaksInfo -----
        all_leaks_info_test=CaseMarkers(test_case_id="27", offset=54),
        # ----- Тест LeaksContent -----
